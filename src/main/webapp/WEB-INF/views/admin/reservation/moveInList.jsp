...
<body>
	...
	<div class="container">
		...
		<div><h1>입주 예약 현황</h1> <p>(신규요청: ${newRequest } 건)</p></div>
			...
			<table class="moveInList table table-striped table-bordered">
				...
				<thead>
					<tr>
						...
						<th>연락처</th>
						<th>인원</th>
						<th class="order" data-value="r_reservedate">입주예정일
						<c:choose>
							<c:when test="${data.order_by=='v_time' and data.order_sc=='ASC'}">▲</c:when>
							<c:when test="${data.order_by=='v_time' and data.order_sc=='DESC'}">▼</c:when>
